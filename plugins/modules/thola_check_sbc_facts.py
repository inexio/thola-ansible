...
DOCUMENTATION = """
---
module: thola_check_sbc_facts
author: "Thola team"
version_added: "1.0.0"
short_description: "Checks the sbc values for a given device"
description:
    - "Checks the sbc values for a given device with SNMP"
requirements:
...
def main():
    ...
    body = thola_client.CheckSBCRequest(
        system_health_score_thresholds=thola_client.models.Thresholds(
            critical_max=critical_max,
            critical_min=critical_min,
            warning_max=warning_max,
            warning_min=warning_min
