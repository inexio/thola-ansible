...
DOCUMENTATION = """
---
module: thola_check_hardware_health_facts
author: "Thola team"
version_added: "1.0.0"
short_description: "Checks the hardware health for a given device"
description:
    - "Checks the hardware health for a given device with SNMP"
requirements:
...
EXAMPLES = """
- name: thola check hardware-health
...
changed:
    ...
    sample: True
thola_check_hardware_health_facts:
    description: "Hardware Health facts"
    returned: always
    type: dict
"""
...
def main():
    ...
    body = thola_client.CheckHardwareHealthRequest(
    ...
    result = check_api.check_hardware_health(body=body).__str__().replace("\'", "\"").replace("None", "null")
    try:
