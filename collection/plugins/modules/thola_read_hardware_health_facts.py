...
DOCUMENTATION = """
---
module: thola_read_hardware_health_facts
author: "Thola team"
version_added: "1.0.5"
short_description: "Reads the hardware health of a device"
description:
    - "Reads the hardware health of a device (e.g. fan speed) using SNMP"
requirements:
...
EXAMPLES = """
- name: thola read hardware health
  thola_read_hardware_health_facts:
    api_host: '{{ api_host }}'
    host: '{{ host }}'
    community: '{{ community }}'
    version: '{{ version }}'
