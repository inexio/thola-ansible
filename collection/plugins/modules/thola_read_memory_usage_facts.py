...
DOCUMENTATION = """
---
module: thola_read_memory_usage_facts
author: "Thola team"
version_added: "1.0.5"
short_description: "Reads the memory usage of a device"
description:
    - "Reads the memory usage of a given device with SNMP"
requirements:
...
EXAMPLES = """
- name: thola read memory usage
  thola_read_memory_usage_facts:
    api_host: '{{ api_host }}'
    host: '{{ host }}'
    community: '{{ community }}'
    version: '{{ version }}'
