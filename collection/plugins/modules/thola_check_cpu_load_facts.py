...
DOCUMENTATION = """
---
module: thola_check_cpu_load_facts
author: "Thola team"
version_added: "1.0.0"
short_description: "Checks the CPU load for a given device"
description:
...
def main():
    ...
    body = thola_client.CheckCPULoadRequest(
        cpu_load_thresholds=thola_client.models.Thresholds(
            critical_max=critical_max,
            critical_min=critical_min,
            warning_max=warning_max,
            warning_min=warning_min
    ...
    result = check_api.check_cpu_load(body=body).__str__().replace("\'", "\"").replace("None", "null")
    try:
