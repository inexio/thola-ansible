...
DOCUMENTATION = """
---
module: thola_read_disk_facts
author: "Thola team"
version_added: "1.0.5"
short_description: "Reads the disk of a device"
description:
    - "Reads the disk partitions of a device and their usage using SNMP"
requirements:
...
EXAMPLES = """
- name: thola read disk
  thola_read_disk_facts:
    api_host: '{{ api_host }}'
    host: '{{ host }}'
    community: '{{ community }}'
    version: '{{ version }}'
