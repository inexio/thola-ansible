...
DOCUMENTATION = """
---
module: thola_read_available_components_facts
author: "Thola team"
version_added: "1.0.5"
short_description: "Reads the available components for the device"
description:
    - "Reads the available components for the device"
requirements:
...
EXAMPLES = """
- name: thola read available components
  thola_read_available_components_facts:
    api_host: '{{ api_host }}'
    host: '{{ host }}'
    community: '{{ community }}'
    version: '{{ version }}'
...
changed:
    ...
    sample: True
thola_read_available_components_facts:
    description: "Available Components facts"
    returned: always
    type: dict
"""
