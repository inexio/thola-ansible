...
DOCUMENTATION = """
---
module: thola_read_cpu_load_facts
author: "Thola team"
version_added: "1.0.5"
short_description: "Reads the CPU load of a device"
description:
    - "Reads the CPU load of a device using SNMP"
requirements:
...
EXAMPLES = """
- name: thola read cpu load
  thola_read_cpu_load_facts:
    api_host: '{{ api_host }}'
    host: '{{ host }}'
    community: '{{ community }}'
    version: '{{ version }}'
